...
impl<'de> serde::de::Visitor<'de> for MapperVisitor {
        ...
        A: serde::de::SeqAccess<'de>,
    {
        ...
        Ok(match id {
            ...
            MapperUnrom::ID => Box::new(seq.next_element::<MapperUnrom>()?.unwrap()),
            MapperMmc1::ID => Box::new(seq.next_element::<MapperMmc1>()?.unwrap()),
            MapperMmc3::ID => Box::new(seq.next_element::<MapperMmc3>()?.unwrap()),
            MapperGxRom::ID => Box::new(seq.next_element::<MapperGxRom>()?.unwrap()),
            MapperMmc2::ID => Box::new(seq.next_element::<MapperMmc2>()?.unwrap()),
            MapperCamerica::ID => Box::new(seq.next_element::<MapperCamerica>()?.unwrap()),
            MapperAxRom::ID => Box::new(seq.next_element::<MapperAxRom>()?.unwrap()),
