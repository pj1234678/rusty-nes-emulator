...
use super::{
    ...
    mapper_caltron::MapperCaltron, mapper_camerica::MapperCamerica,
    ...
    mapper_mmc5::MapperMmc5, mapper_namco175::MapperNamco175,
    mapper_nes_evrom::MapperNesEvtRom, mapper_nina::MapperNina, mapper_nina8::MapperNina8,
    mapper_nrom::MapperNrom, mapper_quattro::MapperQuattro, mapper_rambo1::MapperRambo1,
    mapper_sachen::MapperSachen, mapper_sunsoft_fme7::MapperSunsoftFme7,
    mapper_tqrom::MapperTqrom, mapper_txsrom::MapperTxSrom, mapper_unrom::MapperUnrom,
};
