...
pub fn poke_register(s: &mut State, register: u16, data: u8) {
    ...
    match register {
        ...
        0x4017 => {
            ...
            // Schedule delayed timer reset + quarter/half frame signals
            // Effects occur after 3-4 CPU cycles per NESdev wiki
            // 3 cycles during APU cycle (even), 4 cycles between APU cycles (odd)
